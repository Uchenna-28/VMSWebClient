...
@Component({
  selector: 'app-admin-today-meeting',
  imports: [
    TableComponent,
    InputComponent,
  ...
  templateUrl: './admin-today-meeting.component.html',
  styleUrl: './admin-today-meeting.component.css'
})
export class AdminTodayMeetingComponent {
